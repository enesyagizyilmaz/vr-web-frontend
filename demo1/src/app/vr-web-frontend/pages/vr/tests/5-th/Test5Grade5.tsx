...
const Test5Grade5 = () =>
{
    ...
    return(
        <>
            {!showQuestions && <Welcome handleShowQuestion={handleShowQuestion} testTitle={'Test 5 | Grade 5'}/>}

            {finishTest && <Result testName={'Test 5 | Grade 5'} wrongAnswers={wrongAnswers} questions={question} score={score}/>}
