...
const Test4Grade5 = () =>
{
    ...
    useEffect(() =>
    {
        const fetchAchievements = async () =>
        {
            try
            {
                const response = await getUnit2Grade5Achievements();
    ...
    return(
        <>
            {!showQuestions && <Welcome handleShowQuestion={handleShowQuestion} testTitle={'UNIT 2: The World of Living Things: Test 4 - Grade 5'}/>}

            {finishTest && <Result testName={'UNIT 2: The World of Living Things: Test 4 - Grade 5'} wrongAnswers={wrongAnswers} questions={question} score={score}/>}

            {!finishTest && showQuestions && <TestHandler title={'UNIT 2: The World of Living Things: Test 4 - Grade 5'} questions={question} selectedOptions={selectedOptions} handleOptionChange={handleOptionChange} calculateScore={calculateScore} />}

            <br/>

            {!showQuestions &&
                <AchievementTable
                    title={"Achievements: UNIT 2: The World of Living Things"}
