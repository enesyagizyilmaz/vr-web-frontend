...
const Test6Grade5 = () =>
{
    ...
    return(
        <>
            {!showQuestions && <Welcome handleShowQuestion={handleShowQuestion} testTitle={'Test 6 | Grade 5'}/>}

            {finishTest && <Result testName={'Test 6 | Grade 5'} wrongAnswers={wrongAnswers} questions={question} score={score}/>}
