...
const Test1Grade5 = () =>
{
    ...
    return(
        <>
            {!showQuestions && <Welcome handleShowQuestion={handleShowQuestion} testTitle={'UNIT 1: Sun, Earth and Moon: Test 1 - Grade 5'}/>}

            {finishTest && <Result testName={'UNIT 1: Sun, Earth and Moon: Test 1 - Grade 5'} wrongAnswers={wrongAnswers} questions={question} score={score}/>}

            {!finishTest && showQuestions && <TestHandler title={'UNIT 1: Sun, Earth and Moon: Test 1 - Grade 5'} questions={question} selectedOptions={selectedOptions} handleOptionChange={handleOptionChange} calculateScore={calculateScore} />}
